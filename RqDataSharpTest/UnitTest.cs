...
namespace RqDataSharpTest
{
public class Tests
{
    public IRqDataClient _Client;

    [SetUp]
    public void Setup()
    {
        _Client = new RqDataClient("18621301957", "Hello@123");
    ...
    {
        var rtn = await _Client.get_price_period("RB9999.XSGE", ETimeFrame.m5, ("2019/1/1 9:00:00").ToDateTime(),
        ...
        var rtn5 = await _Client.get_price_period("AU9999.XSGE", ETimeFrame.D1, DateTime.Parse("2020/8/31 17:43:51"),
            DateTime.Now); // 主力连续合约
    ...
    {
        var rtn = await _Client.get_ticks("ZN2112.XSGE", ("2021/10/7").ToDateTime(),
