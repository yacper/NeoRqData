...
public class Tick
{
    ...
    public override string ToString() { return $"{datetime:yyyy-MM-dd HH:mm:ss.fff}     Last:{last,-10} {b1}({b1_v}) -- {a1}({a1_v})    O:{open,-10} H:{high,-10} L:{low,-10} V:{volume,-10} T:{total_turnover}"; }
}
